export default function Footer() {
  return (
    <footer className="relative border-t py-10 px-6" style={{ borderColor: "oklch(0.25 0.08 290 / 0.3)" }}>
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <a
          ...
          className="flex items-center gap-2 btn-secondary text-white text-xs font-medium px-4 py-2 rounded-full"
        >
